 ...
 */
@FragmentScope
public class SearchMusicPreviewModel extends BaseModel implements SearchMusicPreviewContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public SearchMusicPreviewModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<Response2<ResponseListObject<SearchHotBean>>> getSearchHotData() {
