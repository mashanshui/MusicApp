 ...
 */
@FragmentScope
public class SearchMusicInputModel extends BaseModel implements SearchMusicInputContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public SearchMusicInputModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<ResponseListObject<SearchTipBean>> getSearchTip(String keyWord) {
        return mRepositoryManager.obtainRetrofitService(UserService.class)
                .getSearchTip(keyWord);
    }
}